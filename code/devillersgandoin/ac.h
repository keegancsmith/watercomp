/* Code adapted from code written by Frederick W. Wheeler */
/* http://www.cipr.rpi.edu/~wheeler/ac/index.html */
...
void ac_encoder_init (ac_encoder *, FILE *);
void ac_encoder_done (ac_encoder *);
void ac_decoder_init (ac_decoder *, FILE *);
