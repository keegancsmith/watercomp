...
\begin{figure}
  ...
  \caption{A high level overview of how data travels through the compressor
    and decompressor.}
  \label{fig:dimer-angle}
\end{figure}
...
decoder. An example of encoding is given in Table \ref{tab:opttrace}.

\begin{table}
\begin{tabular}{|l|cccc|cccc|cccc|c|}
  \hline

  & \multicolumn{4}{|c|}{\emph{index\_to\_symbol}} &
  \multicolumn{4}{|c|}{\emph{symbol\_to\_index}} &
  \multicolumn{4}{|c|}{\emph{$P_i$ left}} & \emph{Value} \\

  \hline

  & 0 & 1 & 2 & 3 & 0 & 1 & 2 & 3 & 0 & 2 & 3 & 1 & \\

  $pop\_index(0)$ & & 1 & 2 & 0 & 3 & 1 & 2 & & & 2 & 3 & 1 & 0 \\

  $pop\_index(2)$ & & 1 & & 0 & 3 & 1 & & & & & 3 & 1 & 2 \\

  $pop\_index(3)$ & & 0 & & & 1 & & & & & & & 1 & 0 \\

  $pop\_index(1)$ & & & & & & & & & & & & & 0 \\

  \hline
\end{tabular}
\caption{Trace of values for the optimal encoder when encoding the permutation
  $[0, 2, 3, 1]$.}
\label{tab:opttrace}
\end{table}
...
This section presented the design of our components and our water compression
scheme. Our water compression scheme is similiar to those by \citet{merrycomp}
and \citet{gumholdcomp}, but with predictors tailored towards water. The tree
serialisation is similiar to \citet{merrycomp}, except with Breadth First
traversal instead Depth First. The spanning tree creation is also different to
both, using a more optimal (but slower) algorithm for minimising residuals.

The complexity of encoding in our water compression scheme is $O(n + n \log n
...
hotwater & $222$ & $96\,603$ & $200$ & $100\%$ & Water at $1\,000\degree$K \\
...
\caption{Description of DCD files used in compression tests. \emph{Size} is
  the size of the DCD file in megabytes. \emph{Atoms} is the number of atoms
  per frame. \emph{Frames} is the number of frames in the DCD file. \emph{\%
    Water} is the percentage of atoms which are part of a water
  molecule.} \label{tab:testdata}
\end{table}
...
compressor. This is since the performance of our water compressor is directly
...
\centering
\resizebox{\textwidth}{!}{
\begin{tabular}{|lr|rrr|rr|rr|rrr|}
  \hline
  \multirow{2}{*}{\textbf{DCD}} & \multirow{2}{*}{\textbf{atoms}} & \multirow{2}{*}{\textbf{quant}} & \multirow{2}{*}{\textbf{gzip}} & \multirow{2}{*}{\textbf{omel}} & \multicolumn{2}{|c|}{\textbf{gumhold}} & \multicolumn{2}{|c|}{\textbf{dg}} & \multicolumn{3}{|c|}{\textbf{watercomp}} \\

   &  &  &  &  & \emph{null} & \emph{best} & \emph{null} & \emph{best} & \emph{null} & \emph{best} & \emph{gain} \\

  \hline

  smallwater & $699$ & $25.35$ & $\textbf{12.30}$ & $30.00$ & $19.34$ & $27.66$ & $21.74$ & $26.45$ & $18.65$ & $21.75$ & $-9.45$ \\

  water & $96\,603$ & $25.00$ & $21.47$ & $27.72$ & $11.20$ & $26.00$ & $12.86$ & $24.10$ & $\emph{9.24}$ & $\textbf{14.63}$ & $6.84$ \\

  hotwater & $96\,603$ & $25.00$ & $19.08$ & $26.43$ & $10.48$ & $25.56$ & $11.31$ & $22.67$ & $\emph{9.99}$ & $\textbf{15.33}$ & $3.76$ \\

  rabies & $464\,099$ & $25.00$ & $\textbf{13.86}$ & $27.78$ & $\emph{9.28}$ & $25.69$ & $10.17$ & $22.05$ & $14.18$ & $19.44$ & $-5.59$ \\

  hiv & $16\,470$ & $25.02$ & $24.12$ & $27.96$ & $13.89$ & $26.98$ & $15.81$ & $26.67$ & $\emph{12.10}$ & $\textbf{16.26}$ & $7.86$ \\

  mscl & $111\,016$ & $25.00$ & $20.17$ & $27.69$ & $\emph{11.22}$ & $25.89$ & $12.41$ & $23.39$ & $15.94$ & $\textbf{19.13}$ & $1.04$ \\
...
\caption{Compression rates at $8$-bit quantisation. The best ratio is
  ...
  \emph{delta}, \emph{interframe}, \emph{na\"{i}ve} and
  \emph{optimal}. \emph{Gain} is the amount of compression ratio gained
  against the next best scheme.}
\label{tab:res8}
\end{table}
...
graph indicates that our water compression algorithm performs relatively
...
The worst running time for our water compression algorithm is $693$ seconds on
...
\begin{tabular}{|lr|rrr|rr|rr|rrr|}
  ...
  smallwater & $699$ & $37.83$ & $37.39$ & $43.86$ & $32.75$ & $41.07$ & $34.99$ & $39.69$ & $\emph{32.60}$ & $\textbf{35.20}$ & $2.19$ \\

  water & $96\,603$ & $37.50$ & $37.26$ & $40.23$ & $23.62$ & $38.40$ & $26.50$ & $37.74$ & $\emph{20.84}$ & $\textbf{26.23}$ & $11.03$ \\

  hotwater & $96\,603$ & $37.50$ & $36.82$ & $38.92$ & $22.95$ & $38.03$ & $25.19$ & $36.54$ & $\emph{21.50}$ & $\textbf{26.89}$ & $9.65$ \\

  rabies & $464\,099$ & $37.50$ & $32.92$ & $40.27$ & $\emph{21.64}$ & $38.00$ & $24.12$ & $36.00$ & $25.89$ & $\textbf{31.03}$ & $1.89$ \\

  hiv & $16\,470$ & $37.51$ & $37.52$ & $40.51$ & $26.30$ & $39.39$ & $29.25$ & $40.10$ & $\emph{24.49}$ & $\textbf{28.65}$ & $8.86$ \\

  mscl & $111\,016$ & $37.50$ & $37.19$ & $40.19$ & $\emph{23.63}$ & $38.22$ & $26.06$ & $37.04$ & $28.01$ & $\textbf{31.22}$ & $5.82$ \\
...
that our water compression scheme has run times closer in speed to the other
...
The worst increase in run time for our water compression scheme from $8$-bit
...
\resizebox{\textwidth}{!}{
  \begin{tabular}{|l|rrr|rrr|rrr|}
    ...
    \multirow{2}{*}{\textbf{DCD}} &
    \multicolumn{3}{|c|}{\textbf{Clusters}} &
    \multicolumn{3}{|c|}{\textbf{Constant}} &
    \multicolumn{3}{|c|}{\textbf{Hydrogen}} \\

    & \emph{Mean} & \emph{Min} & \emph{Max} & \emph{Mean} & \emph{Min} &
    \emph{Max} & \emph{Mean} & \emph{Min} & \emph{Max} \\

    \hline

    smallwater - 8 & $23$ & $19$ & $27$ & $98$ & $81$ & $112$ & $135$ &
    $121$ & $152$ \\

    smallwater - 12 & $22$ & $18$ & $27$ & $99$ & $88$ & $106$ & $135$ &
    $127$ & $145$ \\

    \hline

    water - 8 & $39$ & $8$ & $1\,086$ & $1\,879$ & $951$ & $9\,192$ &
    $30\,323$ & $23\,009$ & $31\,250$ \\

    water - 12 & $10$ & $1$ & $568$ & $446$ & $189$ & $4\,658$ & $31\,756$ &
    $27\,543$ & $32\,012$ \\

    \hline

    hotwater - 8 & $2\,007$ & 6 & $3\,486$ & $14\,704$ & 838 & $20\,086$ &
    $17\,614$ & $12\,115$ & $31\,363$ \\

    hotwater - 12 & $1\,305$ & 1 & $1\,434$ & $8\,394$ & 184 & $8\,712$ &
    $23\,815$ & $23\,489$ & $32\,017$ \\
...
\caption{Statistics from our water compressor at $8$ and $12$ bit
...
\caption{The relative performance of the permutation encoders on different DCD
  files. The encoder used is our water compressor at $12$-bit
...
encoder with our water compressor at $12$-bit quantisation. The best
...
The speed of our water compressor can be up to three times slower than the
...
Our water compressor implementation joins up the components by adding an edge
...
% LocalWords:  oxygens Deserialisation BFS MSCL intra DCD parallelisation
% LocalWords:  gumhold watercomp
