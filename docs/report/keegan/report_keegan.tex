...
Six different DCD files where used in the experiments. Every DCD file
excluding MSCL was generated by Julian Kenwood using the Nanoscale Molecular
Dynamics (NAMD). A summary of each file is given in Table \ref{tab:testdata}.
...
% LocalWords:  oxygens Deserialisation deserialisation BFS MSCL
