...
#   ./gourcelog.py project.log && gource --highlight-all-users project.log
# OR
#   ./gourcelog.py | gource -
...
# the only thing specific to the watercomp project is the fix to get the user
# "nomad" to be "Julian Kenwood".
#
